...
//        case SizeHint.ExtraShort => base_col_width * 0.25
//        case SizeHint.Short => base_col_width * 0.5
//        case SizeHint.Medium => base_col_width
//        case SizeHint.Long => base_col_width * 1.5
//        case SizeHint.ExtraLong => base_col_width * 2
//        case SizeHint.FullWidth => 0.95
//
//      }
//      Math.max(size, 0.1)
//    }
