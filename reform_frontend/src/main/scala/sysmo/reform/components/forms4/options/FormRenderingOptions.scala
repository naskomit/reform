...
import sysmo.reform.components.forms4.layouts.{ColumnsLayoutComponent, FormGroupLayout}
...
object FormRenderingProps {
  ...
  val form_group_layout = Property[FormGroupLayout](name = "form_group_layout", ColumnsLayoutComponent)
}
